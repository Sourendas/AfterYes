...
export const ClinicsPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.clinicName.trim()) {
      setFormError('Please enter your clinic name.');
      return;
    }
    ...
    if (!formData.agreedToTerms) {
      setFormError('Please agree to the terms to reserve your founding clinic spot.');
      return;
    }
    ...
    setTimeout(() => {
      submitWaitlist({
        ...
        extra: {
          ...
          planInterest: 'Practice ($99/mo lock)',
        },
      });
  ...
  const faqs = [
    {
      q: 'Patient records / EHR?',
      a: 'No. Calendar and contact reminders only. AfterYes handles appointment scheduling, confirmations, and no-show follow-ups.',
    },
    {
      q: 'Medical advice?',
      a: 'Never. AfterYes is strictly scheduling software, not a medical device. We don’t diagnose, treat, or advise.',
    },
    {
      q: 'US and India?',
      a: 'Calendar-first everywhere. Phone numbers by country later as telephony integrations expand.',
    },
  ];
      ...
      <section className="pt-16 sm:pt-24 pb-12 sm:pb-16 px-4 sm:px-6 max-w-[1120px] mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <div className="text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-4">
            FOR HEALTHCARE PRACTICES & CLINICS
          </div>

          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-serif text-[#1A1714] tracking-tight leading-[1.12] mb-6">
            After 6pm, empty rings <br className="hidden sm:inline" />
            are empty chairs.
          </h1>

          <p className="text-base sm:text-lg text-[#6B645C] leading-relaxed mb-8 max-w-2xl mx-auto">
            Reminders, a no-show list, and an optional receptionist that books the calendar. No clinical advice. Ever.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5">
            <button
              onClick={scrollToSignup}
              id="hero-clinic-primary-cta"
            ...
            >
              <span>Get founding $99/mo</span>
              <ArrowRight className="w-4 h-4" />
            </button>
            <button
              onClick={scrollToFlow}
              id="hero-clinic-secondary-cta"
          ...
          <p className="text-xs text-[#6B645C] mt-4">
            First 30 clinics keep $99 for 12 months. No charge today.
          </p>
        </div>

        {/* Warning Strip under hero: #1A1714 text on #F3EDE4 */}
        <div className="mt-10 max-w-2xl mx-auto">
          <div className="bg-[#F3EDE4] border border-[#E7E0D6] rounded-[14px] px-4 py-3 text-center text-xs text-[#1A1714] font-medium flex items-center justify-center gap-2">
            <ShieldAlert className="w-4 h-4 text-[#0F766E] shrink-0" />
            <span>Scheduling software only. Not a medical device. We don’t diagnose, treat, or advise.</span>
          </div>
        </div>

        {/* Practice Workflow Preview Card */}
          ...
          <div className="bg-[#FFFFFF] rounded-[20px] p-6 sm:p-8 border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1">
            <div className="flex items-center justify-between pb-4 border-b border-[#E7E0D6] mb-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6B645C]">Dr. Patel Practice &bull; Dental & Physio</p>
                </div>
              </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="p-3.5 bg-[#FAF7F2] rounded-[12px] border border-[#E7E0D6] flex items-center justify-between">
                <div>
                  <p className="font-medium text-[#1A1714]">7:14 PM &bull; Inbound Caller (New Patient)</p>
                  <p className="text-xs text-[#6B645C]">Slot booked: Thursday 10:30 AM &bull; SMS confirmation dispatched</p>
                </div>
              ...
              <div className="p-3.5 bg-[#FFFFFF] rounded-[12px] border border-[#0F766E] flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#6B645C]">2 canceled slots re-offered to waitlisted patients automatically</p>
                </div>
        ...
        <div className="max-w-[1120px] mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-4xl font-serif text-[#1A1714]">
              Three steps to keep clinic chairs filled
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-[#FFFFFF] p-7 rounded-[20px] border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1 flex flex-col justify-between">
              <div>
                ...
                <p className="text-base text-[#6B645C] leading-relaxed">
                  Connect your existing Google or Outlook calendar in 2 minutes. Sync appointment slots instantly.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#FFFFFF] p-7 rounded-[20px] border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1 flex flex-col justify-between">
              <div>
                ...
                <p className="text-base text-[#6B645C] leading-relaxed">
                  Reminders go out on their own — SMS and WhatsApp confirmations sent 48 hours and 2 hours prior.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#FFFFFF] p-7 rounded-[20px] border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-lg font-serif text-[#1A1714] mb-2">
                  Optional: the phone gets answered
                </h3>
                <p className="text-base text-[#6B645C] leading-relaxed">
                  Optional: the phone gets answered and a slot is booked even after your front desk leaves at 6pm.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-16 sm:py-24 border-t border-[#E7E0D6]">
        <div className="max-w-[1120px] mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-4xl font-serif text-[#1A1714]">
              Clean scheduling designed for busy clinics
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-[#FFFFFF] p-7 rounded-[20px] border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-serif text-[#1A1714] mb-2">
                Reminders before the chair goes empty
              </h3>
              <p className="text-base text-[#6B645C] leading-relaxed">
                Automated multi-channel confirmations that prompt patients to confirm or reschedule before the slot is wasted.
              </p>
            </div>
            ...
            <div className="bg-[#FFFFFF] p-7 rounded-[20px] border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-serif text-[#1A1714] mb-2">
                A no-show list you can actually act on
              </h3>
              <p className="text-base text-[#6B645C] leading-relaxed">
                Instant alerts for staff when a patient cancels late, allowing immediate backfill from your waitlisted patients.
              </p>
            </div>
            ...
            <div className="bg-[#FFFFFF] p-7 rounded-[20px] border border-[#E7E0D6] hover:border-[#0F766E] transition-all duration-200 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-serif text-[#1A1714] mb-2">
                After-hours booking, minute-capped if you add voice
              </h3>
              <p className="text-base text-[#6B645C] leading-relaxed">
                Optional evening receptionist add-on that answers phone calls and books open slots with strict minute caps.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-16 sm:py-24 border-t border-[#E7E0D6]">
        <div className="max-w-[1120px] mx-auto px-4 sm:px-6">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-4xl font-serif text-[#1A1714]">
              Clear pricing for small clinics & practices
            </h2>
            <p className="text-sm sm:text-base text-[#6B645C] mt-2">
              First 30 clinics keep $99 for 12 months.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-3xl mx-auto mb-8">
            ...
            <div className="bg-[#FFFFFF] rounded-[20px] p-7 sm:p-8 border-2 border-[#0F766E] flex flex-col justify-between hover:-translate-y-1 transition-all duration-200">
              <div>
                ...
                <h3 className="text-2xl font-serif text-[#1A1714] mb-2">Practice</h3>
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-4xl font-serif text-[#1A1714]">$99</span>
                ...
                <ul className="space-y-3 text-sm text-[#1A1714] mb-8">
                  <li className="flex items-center gap-2.5">
                    ...
                    <span>1 provider calendar sync</span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                  ...
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                    <span>Actionable no-show list</span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                    <span>Online rescheduling portal</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-[#FFFFFF] rounded-[20px] p-7 sm:p-8 border border-[#E7E0D6] hover:border-[#0F766E] flex flex-col justify-between hover:-translate-y-1 transition-all duration-200">
              <div>
                ...
                <h3 className="text-2xl font-serif text-[#1A1714] mb-2">Practice+</h3>
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-4xl font-serif text-[#1A1714]">$149</span>
                  <span className="text-sm font-sans text-[#6B645C]">/mo</span>
                </div>
                ...
                <ul className="space-y-3 text-sm text-[#1A1714] mb-8">
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                    <span>2 provider calendars</span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                    <span>Priority SMS dispatch</span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                    <span>Detailed call log & analytics</span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#0F766E] shrink-0" />
                    <span>Multi-staff dashboard</span>
                  </li>
                </ul>
              </div>
              ...
              >
                <span>Join waitlist for Practice+</span>
          ...
          {/* Add-on Banner Card */}
          <div className="max-w-3xl mx-auto bg-[#FFFFFF] p-6 rounded-[20px] border border-[#E7E0D6] mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-[12px] bg-[#E6F4F1] text-[#0F766E] flex items-center justify-center shrink-0">
                <PhoneCall className="w-5 h-5" />
              </div>
              <div>
                <h4 className="text-base font-serif text-[#1A1714]">Optional Voice Receptionist Add-on</h4>
                <p className="text-xs text-[#6B645C]">
                  +$49/mo — 100 after-hours receptionist minutes included, then $0.25/min.
                </p>
              </div>
            </div>
            <span className="text-xs font-semibold text-[#0F766E] bg-[#E6F4F1] px-3 py-1.5 rounded-[10px] shrink-0">
              Voice Add-on +$49/mo
            </span>
          </div>

          <div className="max-w-3xl mx-auto text-center text-xs text-[#6B645C]">
            <p>First 30 clinics keep $99 for 12 months.</p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-[#FFFFFF] rounded-[20px] p-7 sm:p-10 border border-[#E7E0D6]">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-[#6B645C] mt-2">
                Lock $99/mo practice rate before public rollout.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-left">
              <div>
                <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-lead-name">
                  Your Full Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-name">
                ...
                <input
                  ...
                  id="clinic-name"
                  required
                  placeholder="Beacon Hills Dental Care"
              ...
              <div>
                <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-email">
                  Clinic Email
                </label>
                <input
                  type="email"
                  id="clinic-email"
                  required
                  placeholder="appointments@beaconhillsdental.com"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-country">
                    Country
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-specialty">
                    Specialty
                  </label>
                  <select
                    id="clinic-specialty"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-appointments">
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, weeklyAppointments: e.target.value })}
                    className="w-full px-4 py-3 rounded-[12px] border border-[#E7E0D6] bg-[#FAF7F2] text-sm text-[#1A1714] focus:bg-[#FFFFFF] focus:outline-hidden focus:border-[#0F766E]"
                  />
                </div>

                <div>
                  <label className="block text-xs uppercase tracking-[0.12em] font-sans font-medium text-[#6B645C] mb-1.5" htmlFor="clinic-phone">
                    Phone (Optional)
                  </label>
                  <input
                    type="tel"
              ...
              <div className="pt-2">
                <label className="flex items-start gap-2.5 text-xs text-[#6B645C] cursor-pointer">
                  ...
                  <span>
                    ...
                    and acknowledge that AfterYes is scheduling software and not a medical device.
                  </span>
                </label>
              </div>
              ...
              >
                {isSubmitting ? (
                  <span>Reserving clinic spot...</span>
                ) : (
                  <>
                    <span>Join the clinic list</span>
                    <ArrowRight className="w-4 h-4" />
                  </>
                )}
              </button>
